...
function copyToClipboard() {
    var text = "https://one-eight.io/?ref=" + web3.eth.accounts[0];
...
document.getElementById("reflink").innerHTML = "https://one-eight.io/?ref=" + web3.eth.accounts[0];
...
function tick(){
    ...
    getBalance(updateContractBalance);
}
...
function updateContractBalance(data) {
    document.getElementById("contract-balance").innerHTML = formatETH(data / 1000000000000000000) + " ETH";
    //  TODO: Ronald
    // document.getElementById("contract-balance-usd").innerHTML = '(' + Number((convertWeiToEth(r) * ethPrice).toFixed(2)).toLocaleString() + ' ' + currency + ')';
